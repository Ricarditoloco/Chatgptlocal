...
def generate_poem():
    ...
    output_label.config(text=poem)  # Mostrar el texto en la etiqueta de salida
...
# Crear el botón de generación de texto
generate_button = tk.Button(root, text="Generar Respuesta", command=generate_poem)
generate_button.pack(pady=5)

# Crear la etiqueta para mostrar el texto generado
